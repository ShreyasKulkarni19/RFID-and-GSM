...
// Create instances
SoftwareSerial SIM800(3, 4); // SoftwareSerial SIM800(Rx, Tx)
...
String tagUID = "72 73 7D 89";  // String to store UID of tag. Change it with your tag's UID
...
void setup() {
  ...
  // Arduino communicates with SIM800 GSM shield at a baud rate of 19200
...
void receive_message()
{
  ...
  {
    incomingData = SIM800.readString(); // Get the incoming data.
    delay(10);
  }
...
void send_message(String message)
{
  ...
  delay(100);
  SIM800.println("AT+CMGS=\"+919047189499\""); // Replace it with your mobile number
  delay(100);
